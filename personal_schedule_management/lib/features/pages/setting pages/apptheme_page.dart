                  ...
                  Container(
                      ...
                      child: Icon(Icons.image,
                          ...
                          color: _selectedTheme == element
                              ? settingsController.GetAppThemeExample(element)
                                  .onPrimary
                              : settingsController.GetAppThemeExample(element)
                                  .primary)),
                  Text(element,
              ...
              children: [
                ...
                InkWell(
                  child: ListTile(
                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                color:
                                    AppTheme.of(context, listen: true).darkMode
                                        ? Colors.yellow
                                        : Colors.black),
                      ...
                      trailing: Switch(
                          value: AppTheme.of(context, listen: true).darkMode,
                          onChanged: (isOn) {
                            AppTheme.of(context, listen: false)
                                .ToggleDarkMode();
                          })),
                ),
                Container(
