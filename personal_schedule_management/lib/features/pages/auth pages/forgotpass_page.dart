                ...
                children: [
                  ...
                  Container(
                      ...
                      height: MediaQuery.of(context).size.width * imageRatio <
                          ...
                          : MediaQuery.of(context).size.height *
                              maxImageHeightRatio,
                      child: Image.asset('assets/image/forgotpass_image.png')),

                  Container(
                      alignment: Alignment.center,
                      child: Text(
                        'Hãy nhập email và chúng tôi sẽ gửi\n đường link đặt lại mật khẩu',
                ...
                children: [
                  ...
                  Container(
                      ...
                      height: MediaQuery.of(context).size.width * imageRatio <
                          ...
                          : MediaQuery.of(context).size.height *
                              maxImageHeightRatio,
                      child: Image.asset('assets/image/sendmail_image.png')),
